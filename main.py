...
class Conexion:
    ...
    conexion.consultar_departamento(departamento_id = 1)
    conexion.consultar_alcalde(alcalde_id = 1)
    conexion.consultar_proyecto(proyecto_id = 1)
    conexion.consultar_proveedor(proveedor_id = 1)
    conexion.consultar_contrato(contrato_id = 1)
    conexion.consultar_empleado(empleado_id = 1)
    conexion.consultar_presupuesto_municipal(presupuesto_id = 1)
    conexion.consultar_programa_social(programa_id = 1)
